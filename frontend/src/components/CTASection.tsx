...
export const CTASection = () => {
  return (
    <section className="py-20 md:py-32 bg-gradient-to-br from-green-600 to-emerald-600 relative overflow-hidden">
      {/* Decorative elements */}
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <motion.p
            ...
            className="text-xl text-green-50 mb-10 max-w-2xl mx-auto"
          >
          ...
          <motion.p
            ...
            className="text-sm text-green-50 mt-6"
          >
